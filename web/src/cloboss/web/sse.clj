...
(ns cloboss.web.sse
  "Provides Server-Sent Events via [[cloboss.web.async/as-channel]]"
...
(def as-channel
  "Decorates the result of [[cloboss.web.async/as-channel]] with the proper SSE Content-Type."
  (comp with-event-type async/as-channel))

(defn send!
  "Formats an event according to the SSE spec and sends it via [[cloboss.web.async/send!]].
